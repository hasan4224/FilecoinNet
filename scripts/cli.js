...
const contractABI = require("../artifacts/contracts/Filecoinnet.sol/Filecoinnet.json").abi;

program
    .name("filecoinnet-cli")
    .description("CLI tool for Filecoinnet smart contract")
    .version("1.0.0");
