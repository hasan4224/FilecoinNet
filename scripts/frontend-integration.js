 ...
 * This file demonstrates how to integrate Filecoinnet with a web frontend
 */

// For React/Vue/Angular applications
export class FilecoinnetClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new FilecoinnetClient(provider, contractAddress);
